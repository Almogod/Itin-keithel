  ...
  return (
    <Section space="chapter">
      <Container size="editorial">
        <Stack gap={6}>
          <Eyebrow tone="vermilion">Portal · Admin</Eyebrow>
          ...
          <p className="text-[1.0625rem] text-ink-700 leading-[1.7]">
            The admin portal — banners, categories, guilds, vendors, customers, orders, and reports.
            Phase 6 fills the shell you see here. For now this proves the workspace and the shared
            UI package are wired.
          </p>
          <p className="small-caps text-[0.72rem] text-muted">
            localhost:3002 · builds from packages/ui &amp; packages/services
          </p>
          <div className="pt-4">
